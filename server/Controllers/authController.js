...
RegisterUser = async (req, res) => {
    try {
        ...
        const SESSION_TOKEN = jwt.sign(
            { userId: newUser._id, profile_image: newUser.profile_image, email: newUser.email, name: newUser.name, user_role: newUser.user_role, createdAt: newUser.createdAt },
...
LoginUser = async (req, res) => {
    try {
        ...
        const SESSION_TOKEN = jwt.sign(
            { userId: existingUser._id, profile_image: existingUser.profile_image, email: existingUser.email, name: existingUser.name, user_role: existingUser.user_role, createdAt: existingUser.createdAt },
            process.env.JWT_SECRET,
            { expiresIn: '7d' }
        );
