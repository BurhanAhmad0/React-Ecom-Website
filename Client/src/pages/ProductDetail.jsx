            ...
            {loading ? (
                ...
                <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
                    ...
                    <div className="flex flex-col justify-between space-y-4">
                        ...
                        <button onClick={() => handleAddToCart(product._id)} className="cursor-pointer mt-4 w-full md:w-auto bg-blue-600 text-white py-2 px-6 rounded hover:bg-blue-700 transition">
                            Add to Cart
                        </button>
                    </div>
                </div>
